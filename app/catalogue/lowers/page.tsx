...
export default function LowersPage() {
  const lowers = allProducts.filter((product) => product.type === "lower")
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-r from-gray-50 to-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">Sole Collection</h1>
          <p className="text-lg text-gray-600 font-medium max-w-2xl mx-auto">
            High-performance soles engineered for durability and comfort. Perfect for any upper design.
          </p>
        </div>
      </section>
